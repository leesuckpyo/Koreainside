...
7. 관련 page spec 문서를 작성하거나 업데이트한다.
...
- 기존 기능과 콘텐츠가 보존된다.
- 개선 목적이 충족된다.
- 관련 문서와 Change Management가 반영된다.
