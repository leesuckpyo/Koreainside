# Korea Inside — Gongdeok & Mapo Approved Public Copy

**Status:** APPROVED PUBLIC COPY — CONTENT LOCKED  
**Date:** 2026-09-19  
**Target page:** Gongdeok & Mapo Travel Guide — final HTML filename not yet approved  
**Page role:** Local Seoul Discovery Guide  
**Editorial definition:** Local Seoul Discovery Guide — connecting local food with bookable experiences.  
**Design family:** Travel Guide Family Design Standard V1  
**Golden Sample:** `hongdae-travel-guide.html`  
**Research Master:** `Korea_Inside_Gongdeok_Mapo_Research_Master_2026-09-19.md`  

**Important:** Public copy below is approved. Codex must not rewrite, humanize, shorten, expand, reorder, or invent copy without explicit user approval.

**Still requiring separate final approval / verification before Production:**
- final HTML filename / canonical URL
- SEO title
- meta description
- exact affiliate URLs / tracking
- current product availability, inclusions, language, duration, cancellation rules, and meeting points
- any current operating facts that may change
- image selection, rights, caption, credit, alt text
...
**Choose jokbal when dinner itself is the main event.**  
**Choose jeon when you want to taste several things, drink something with them and keep the evening moving.**
...
**jeon and drinks at Gongdeok Market**,  
or **jokbal as the main dinner**,  
or **pork galbi near Mapo Station**,  
or **an older Seoul meal such as seolleongtang or naengmyeon**.
...
→ short walk along the forest-park area  
→ café or return to your hotel

**Option 2 — Mapo dinner**

Arrive around Mapo or Gongdeok  
→ pork galbi, seolleongtang or another older neighborhood meal  
→ walk toward the Gongdeok side  
→ dessert, café or one small experience  
→ finish the evening

**Option 3 — Experience first**

Dessert class or another booked activity  
→ one proper dinner  
...
## Stay in Gongdeok or Keep Looking?

If Gongdeok already fits the way you plan to move around Seoul, compare the hotels around the station before booking.

If you are still deciding between neighborhoods, choose the **area first** and the hotel second.

**See where to stay in Seoul**

That keeps the decision in the right order:

**trip style → neighborhood → hotel → booking**

not:

**hotel deal → neighborhood justification afterward.**
...
+ a relaxed Seoul evening.

**Skip it when you need:**

major sights  
+ big nightlife  
+ a tightly packed first-trip itinerary.
...
**Gongdeok Station**  
→ market or booked experience  
→ local dinner  
→ walk toward Mapo or the forest-park side  
→ finish the evening

or

**Mapo Station**  
→ pork galbi or older neighborhood restaurant  
→ walk toward Gongdeok  
→ café, drink or quiet finish  
→ Gongdeok Station for the ride home
...
**Gongdeok** for the market and many nearby experiences.  
**Mapo** for the Yonggang-dong food side and pork-galbi dinner.
...
- Public copy above is approved and content-locked.
- Do not create or rename the final HTML file until the filename / URL is approved.
- Do not invent an SEO title or meta description.
- Do not invent affiliate URLs. Use only verified, approved partner links.
- Before Production, recheck all current activity availability and product conditions.
- Do not imply that a specific activity is always available.
- Current restaurant history / dates / named-place facts should be rechecked before Production if they are treated as current facts.
- Apply `docs/design-travel-guide.md` / Travel Guide Family Design Standard V1.
